...
export const metadata = {
  title: "About",
  description:
    "I’m Angelina Jolie. I live in New York City, where I design the future.",
};
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>
              I have a passion for building beautiful, snappy, and performant web applications.
              I have worked at big tech companies and small and medium startups.
              Even though I focus on the frontend, I am comfortable with all
              parts of the stack, from designing UIs, publishing npm packages,
              building backend APIs and databases.
            </p>
            <p>
